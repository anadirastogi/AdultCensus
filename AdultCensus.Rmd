...
## Model accuracy = (21052+4591)/32561 = 78.75%
```
...
plot(rd_model_roc,print.auc=TRUE,print.auc.y=.4, col="green")
```

## Create ROC curve for all classifiers
```{r}
